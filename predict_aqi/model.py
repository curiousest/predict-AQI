...
def generate_predictions(all_data,
    ...
    first_step_predictions = predict_values(first_step_regressor, all_data[first_step_feature_columns])
    ...
    second_step_predictions = predict_values(second_step_regressor, all_data[second_step_feature_columns])
